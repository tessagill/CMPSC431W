...
def create_planned_payments_table():
    ...
    # Queries to INSERT records. 
    cursor.execute('''INSERT INTO planned_payments VALUES (1231, 1, 'Rent', 1200, TRUE)''') 
    cursor.execute('''INSERT INTO planned_payments VALUES (1231, 15, 'Netflix', 20, TRUE)''') 
    cursor.execute('''INSERT INTO planned_payments VALUES (1231, 30, 'Utilities', 75, TRUE)''') 
    cursor.execute('''INSERT INTO planned_payments VALUES (1232, 1, 'Rent', 2000, TRUE)''') 
    cursor.execute('''INSERT INTO planned_payments VALUES (1232, 15, 'Utilites', 150, TRUE)''') 
    cursor.execute('''INSERT INTO planned_payments VALUES (1233, 1, 'Rent', 750, TRUE)''') 
    cursor.execute('''INSERT INTO planned_payments VALUES (1233, 1, 'Vacation', 1500, FALSE)''') 
    cursor.execute('''INSERT INTO planned_payments VALUES (1234, 15, 'Rent', 2000, TRUE)''') 
    cursor.execute('''INSERT INTO planned_payments VALUES (1234, 15, 'Netflix', 20, TRUE)''') 
